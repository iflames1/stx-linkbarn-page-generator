    ...
    <section className="py-24 relative">
      ...
      <div className="relative container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold bg-gradient-to-r from-orange-400 to-pink-400 text-transparent bg-clip-text mb-4">
            Tokenomics
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {tokenomics.distribution?.map((item, index) => {
            ...
            return (
              ...
              >
                <Card className="bg-orange-900/30 border-orange-500 overflow-hidden relative transform hover:scale-105 transition-all ">
