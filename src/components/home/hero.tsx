    ...
    <section className="pt-20 px-4 h-screen">
      ...
      <div className="relative z-10">
        <div className="max-w-6xl mx-auto flex flex-col items-center">
          ...
          <motion.h1
            className="text-7xl font-bold mb-6 bg-gradient-to-r from-[#FF5E00] to-[#FF4500] text-transparent bg-clip-text"
          ...
          <motion.p
            className="text-2xl mb-8 text-[#FF5E00] max-w-2xl text-center"
            initial={{ y: -50, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
          ...
          >
            <Button
              size="lg"
              variant="outline"
              className="bg-[#FF5E00] hover:bg-white hover:text-[#FF5E00] border-[#FF5E00] transform hover:scale-105 transition-all"
              asChild
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-[#FF5E00] text-[#FF5E00] hover:bg-[#FF5E00] hover:text-white transform hover:scale-105 transition-all"
            >
              <Link href={"#socials"}>Join Community</Link>
            </Button>
          </motion.div>

          <Alert className="bg-[#FF5E00] border-orange-500 max-w-2xl glow-on-hover">
